        ...
        if (!o.auto) {
            ...
            case 'myRange':
                data = [{
                    ...
                    grouping: '{"name":"Shooting Range Z","groups":[{"name":"environment","node":"environment","parts":["grass","tree_line","sky","targets","ShootingRangeArea1","ShootingRangeArea2","ShootingRangeArea3","ShootingRangeArea4","ShootingRangeArea5","ShootingRangeArea6","ShootingRangeArea7","ShootingRangeArea8"]}]}'
                }];
                break;
            case 'myM4':
                data = [{
